...
public class MandelbrotWorkStealingPool extends JFrame {
    ...
    public MandelbrotWorkStealingPool(int width, int height) {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        PrintWriter printWriter = new PrintWriter(new FileWriter("./newWorkStealingPool.csv"));
        printWriter.println("implementation, tasks, time");
        printWriter.flush();
        ...
        for(int probe = 1; probe < 10; probe++){
            for(int threads_number = 1; threads_number <= 90; threads_number += 10) {
                ...
                printWriter.flush();
                printWriter.println("newWorkStealingPool, " + tasks_number + ", " + accurate_time);
                System.out.println("Impl: newWorkStealingPool, Tasks: " + tasks_number + ", Time: " + accurate_time.toString());
            }
        }
