...
public class ProducerConsumerHighValues {
    ...
    public static class Producer implements Runnable{
        ...
        public void run() {
            ...
            while(shouldRun){
                try {
                    int elementsToProduce = generator.nextInt(M/2)+M/2;
    ...
    public static class Consumer implements Runnable{
        ...
        public void run() {
            while(shouldRun){
                try {
                    int elementsToConsume = generator.nextInt(M/2)+M/2;
    ...
    static {
        try {
            producer_fileWriter = new FileWriter("/Users/jakub/IdeaProjects/TW-lab3/HVproducerPK1000M100000.csv");
            consumer_fileWriter = new FileWriter("/Users/jakub/IdeaProjects/TW-lab3/HVconsumerPK1000M100000.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
