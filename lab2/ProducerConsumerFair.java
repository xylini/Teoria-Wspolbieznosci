...
public class ProducerConsumerFair {
    ...
    public static class Producer implements Runnable{
        ...
        public void run() {
            ...
            while(true){
                try {
                    int elementsToProduce = generator.nextInt(maxProduction)+1;
    ...
    public static class Consumer implements Runnable{
        ...
        public void run() {
            while(true){
                try {
                    int elementsToConsume = generator.nextInt(maxConsumption)+1;
    ...
    static {
        try {
            producer_fileWriter = new FileWriter("/Users/jakub/IdeaProjects/TW-lab3/fairProducerPK1000M100000.csv");
            consumer_fileWriter = new FileWriter("/Users/jakub/IdeaProjects/TW-lab3/fairConsumerPK1000M100000.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
